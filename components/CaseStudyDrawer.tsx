...
function DrawerInnerContent({ caseStudy, onClose }: { caseStudy: CaseStudy, onClose: () => void }) {
    ...
    // Scroll Logic tied to the specific container
    // We pass the ref object manually or undefined if not ready
    ...
    const blurOpacity = useTransform(scrollY, [100, 300], [0, 1]);
            ...
            <div ref={containerRef} className="h-full w-full overflow-y-auto no-scrollbar scroll-smooth snap-y snap-mandatory bg-black">
                ...
                <div className="relative h-[400vh] w-full">
                    ...
                    <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden">
                        ...
                        {/* 2. Blurred Duplicate Layer (Fades In) */}
                        <motion.div
