                                ...
                                >
                                    <div className="max-w-4xl mx-auto flex flex-col gap-24">
                                        ...
                                        <div className="flex flex-col gap-8">
                                            <span className="inline-block w-fit px-4 py-1.5 bg-white/80 text-black text-[14px] font-bold uppercase tracking-widest backdrop-blur-sm">
                                        ...
                                        <div className="pt-32 border-t border-white/5 text-center">
                                            <p className="inline-block w-fit px-4 py-1.5 bg-white/80 text-black text-[14px] font-bold uppercase tracking-widest backdrop-blur-sm mb-8">
