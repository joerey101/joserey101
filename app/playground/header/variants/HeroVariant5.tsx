...
export default function HeroMobileFinal() {
    ...
    }, [displayText, isErasing, showNew, currentIndex, current.old, current.new]);
                ...
                <div className="mb-8">
                    ...
                    <div className="min-h-[180px] flex items-center justify-center mb-6">
                        <h1 className="text-5xl font-black tracking-tight leading-tight">
                            <span className={`block transition-all duration-300 ${!showNew
                    ...
                    <div className="space-y-3 mb-8">
                        <div className={`text-2xl font-black tracking-tight transition-opacity duration-500 ${currentIndex === 0 && showNew ? 'text-cyan-400' : 'text-white'
                            }`}>
                            + ESTRATEGIA
                        </div>
                        <div className={`text-2xl font-black tracking-tight transition-opacity duration-500 ${currentIndex === 1 && showNew ? 'text-pink-500' : 'text-white'
                            }`}>
                            + SISTEMAS
                        </div>
                        <div className={`text-2xl font-black tracking-tight transition-opacity duration-500 ${currentIndex === 2 && showNew ? 'text-cyan-400' : 'text-white'
                            }`}>
                            + MENTE DIGITAL
                        </div>
                    </div>
